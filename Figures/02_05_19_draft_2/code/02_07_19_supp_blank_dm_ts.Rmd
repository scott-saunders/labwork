...
blank_estimates_og <- blank_estimates %>% 
  ...
  mutate(dm_high = dm_from_a_OG(estimate = conf.high, i_0 = i0_soak, dap = blank_dap, t_s = 0.008)) %>% 
  mutate(dm_low = dm_from_a_OG(estimate = conf.low, i_0 = i0_soak, dap = blank_dap, t_s = 0.008))
...
blank_estimates_noFlux <- blank_estimates %>% 
  ...
  mutate(dm_high = dm_from_a_noFlux(estimate = conf.high, i_0 = i0_soak, dap = blank_dap, t_s = 0.008)) %>% 
  mutate(dm_low = dm_from_a_noFlux(estimate = conf.low, i_0 = i0_soak, dap = blank_dap, t_s = 0.008)) 
