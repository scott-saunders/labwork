...
ggplot(df_wt_retRatio %>% filter(condition %in% c('etbr','h2o')), aes(x = condition_conc, y = ret_ratio)) +
...
ggplot(df_wt_retRatio %>% filter(condition %in% c('pi','h2o','dmso')), 
